  ...
  return (
    <div className="border border-neutral-500 bg-gradient-to-br from-black/40 to-black/10 text-zinc-200 mt-10 m-4 mb-5 pb-4 relative group">
      ...
      <div className="flex flex-row justify-around gap-2 px-auto">
        {/* First Block */}
        <Link href={'/education'} className="text-sm border-black bg-black border p-2 flex flex-col justify-center items-center text-center">
          <Image
        ...
        <div
          className="text-sm border-black bg-black border p-2 flex flex-col justify-center items-center text-center cursor-pointer"
      ...
      <div className="px-4 text-sm pt-5 text-justify space-y-4">
        <p>
          ...
          <span className="font-semibold text-blue-400">Final Year B.tech CSE Student</span> with a strong foundation in{' '}
          <span className="font-semibold text-green-400">Python</span> and{' '}
          <span className="font-semibold text-green-400">Django</span>. While my primary focus lies in backend
          development, I&apos;ve also honed my skills in web development using{' '}
          <span className="font-semibold text-purple-400">Next.js</span>, giving me a versatile edge when building
          dynamic and responsive applications.
        </p>

        <p>
          Beyond coding, I&apos;ve taken on leadership roles in organizing{' '}
          <span className="font-semibold text-yellow-400">college fests and events</span>, including{' '}
          <span className="font-semibold text-yellow-400">debates</span>,{' '}
          <span className="font-semibold text-yellow-400">coding quests</span>, and various other activities. These
        ...
        <p>
          ...
          <span className="font-semibold text-red-400">YouTube channel</span> dedicated to{' '}
          <span className="font-semibold text-red-400">programming</span>, where I create content to help others learn
          and grow in the field.
        </p>

        <p>
          Additionally, I&apos;ve gained valuable professional experience during my internship with{' '}
          <span className="font-semibold text-orange-400">Edureka</span>, where I further sharpened my skills and
          industry knowledge.
        </p>
